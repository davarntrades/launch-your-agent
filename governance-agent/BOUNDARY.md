...
Run: `python3 attacks/run_attacks.py` (attacks) · `python3 attacks/mutation_check.py` (removes each guard and confirms that at least one attack then reports OPEN).
